<?php
  ...
  $user_result = $login->get_existance_of_an_user($username);
  ...
  if($user_result->num_rows<=0)
  {
    ...
    if(password_verify($password, $user['user_password']))
    {
      ...
      $_SESSION['user_institute'] = $user['user_institution'];
      ...
      $response['data']['user_institute']=$_SESSION['user_institute'];
      $response['data']['user_designation']=$_SESSION['user_designation'];
