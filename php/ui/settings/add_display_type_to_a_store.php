...
<?php
    ...
    if($_SERVER['REQUEST_METHOD']!='POST'){
     ...
     if(!isset($_POST['typeno']) || !isset($_POST['displayno']) ){
         $response['error'] = true;
    ...
    try{
        ...
        $result = $select->insertStoreDisplayTypeToStore($storeno, $typeno, $displayno);

      	if ($result) {
              $response['error'] = false;
              $response['message'] = "Display type added successfully";
      	}else{
              $response['error'] = true;
